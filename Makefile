...
# Fichiers source
SRCS = code/main.cpp code/interface/Menu.cpp code/interface/TableauDesScores.cpp code/interface/GameOver.cpp code/interface/GameOverMulti.cpp code/global_variables.cpp code/Animation.cpp code/objet/Entite.cpp code/objet/asteroide.cpp code/objet/tir.cpp code/objet/player.cpp # Ajoutez ici tous les fichiers source de votre projet
