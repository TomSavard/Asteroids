...
# Fichiers source
SRCS = code/main.cpp code/interface/Menu.cpp code/interface/TableauDesScores.cpp code/interface/GameOver.cpp code/global_variables.cpp code/Animation.cpp code/objet/Entite.cpp # Ajoutez ici tous les fichiers source de votre projet
